...
Adding the target audience improved the writing style for recruiters, but it didn't help with missing project details. Claude still left placeholders because I hadn't provided all the required information.
